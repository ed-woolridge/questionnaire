...
public class OptionController {
    ...
    public void create(@Parameter(description = "选项信息", required = true) @RequestBody Option option) {
        optionService.create(option);
    }

    @PutMapping("/update")
    @Operation(summary = "更新选项", description = "更新现有选项信息")
    public void update(@Parameter(description = "选项信息", required = true) @RequestBody Option option) {
    ...
    public List<Option> list(@Parameter(description = "问题ID", required = true) @PathVariable Long questionId) {
        return optionService.listByQuestionId(questionId);
    }
}
